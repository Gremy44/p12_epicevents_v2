...
urlpatterns = [
    ...
    path('customers/<int:pk>/', ClientDetailView.as_view(), name='detail_customers'),
    ...
    path('events/<int:pk>', EventDetailView.as_view(), name='detail_events'),
    ...
    path('contracts/<int:pk>', ContractDetailView.as_view(), name='detail_contracts'),
    ...
    path('staff/<int:pk>/', StaffDetailView.as_view(), name='detail_staff'),
